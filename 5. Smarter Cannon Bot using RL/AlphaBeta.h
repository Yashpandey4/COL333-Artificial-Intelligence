...
int cannons(GameMatrix *state)
{
    ...
    return 60*(cannonkills1-cannonkills2)+ 10*(cannoncount[0]+cannoncount[1]+cannoncount[2]) + 0*(backcan[0]+backcan[1]+backcan[2]) + 5*(sidecan[0]+sidecan[1])
                                         -0*(cannonbad[0]+cannonbad[1]+cannonbad[2]) + 0*(backcanbad[0]+backcan[1]+backcan[2]) -0*(badsidecan[0]+badsidecan[1]);
}
...
int evaluation(GameMatrix *state)
{
    ...
    int p = cannons(state);
    // if(s1-s2>=6)
    //     return 10000*(t1-t2) + 400*s1-450*s2 + p;
    return 10000*(t1-t2) + 400*s1-400*s2 + p;
}
...
{ 
    ...
    //     {
    //         return (-1*(state->MeNoOfTownhalls-state->OpNoOfTownhalls)*4 + 4)*(-120000);
    //     }
    //     else if(state->OpNoOfTownhalls==2 )
    //     {
    //         return ((state->MeNoOfTownhalls-state->OpNoOfTownhalls)*4 + 4)*120000;
    //     }
    // }
    ...
    //     {
    //         return (-1*(state->MeNoOfTownhalls-state->OpNoOfTownhalls)*4 + 6)*(-120000);
    //     }
    //     if(state->OpNoOfSoldiers==0)
    //     {
    //         return ((state->MeNoOfTownhalls-state->OpNoOfTownhalls)*4 + 6)*(120000);
    //     }
    // }
    if(d==0)
    {
    ...
    //     return ((state->MeNoOfTownhalls-state->OpNoOfTownhalls)*4-2)*(120000);
    // }
    ///////////////////
    int v = INT32_MIN;
    int temp = 0;
